...
export function WorkCard({
  ...
  const visual = (
    <div className={frameClass}>
      ...
      <div className="pointer-events-none absolute inset-x-4 bottom-4 z-30 flex items-center justify-between gap-2 sm:inset-x-7 sm:bottom-7">
        <span className="rounded-full border border-white/15 bg-black/55 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur-md">
