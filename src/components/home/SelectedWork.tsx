  ...
  return (
    <section id="home-selected-work" className="relative scroll-mt-24 bg-[var(--background-primary)] py-14 min-[480px]:py-16 md:py-28 lg:py-32 2xl:py-36">
      ...
      <div className="mx-auto w-full max-w-[1560px] px-[clamp(1rem,5vw,2rem)] sm:px-8 lg:px-12 2xl:px-16">
        <div className="mb-8 flex flex-col items-start gap-5 sm:mb-14 sm:gap-7 border-b border-white/10 pb-9 sm:mb-14 md:flex-row md:items-end md:justify-between lg:mb-16 2xl:mb-18">
          <div>
            ...
            <h2 className="max-w-4xl font-display text-[clamp(2rem,10vw,3rem)] sm:text-[clamp(2.6rem,5vw,5.25rem)] font-semibold leading-[0.94] tracking-[-0.052em] text-[var(--text-primary)]">
        ...
        {secondary.length > 0 && (
          <div className="mt-9 grid grid-cols-1 gap-9 sm:mt-12 sm:gap-12 md:mt-16 md:grid-cols-2 md:gap-8 lg:mt-20 lg:gap-12 2xl:gap-14">
