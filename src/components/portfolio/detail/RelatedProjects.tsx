              ...
              <div className="relative aspect-video w-full overflow-hidden rounded-[10px] border border-white/10 bg-[var(--surface-primary)]">
                {imageUrl ? (
                  canUseOptimizedImage(imageUrl) ? (
                    <Image src={imageUrl} alt={alt} fill sizes="(max-width: 767px) 100vw, 33vw" className="object-cover object-center transition-transform duration-500 motion-reduce:transition-none group-hover:scale-[1.01]" />
                  ) : (
