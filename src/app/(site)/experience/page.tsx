      ...
      <section className="bg-[var(--background-primary)] py-14 sm:py-18 lg:py-20">
        <div className="relative mx-auto w-full max-w-[1280px] px-5 sm:px-8 lg:px-12">
          <div className="relative grid gap-8 overflow-hidden border border-white/10 bg-[var(--surface-primary)] px-6 py-9 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1fr)_1px_auto] lg:items-center lg:gap-10 lg:px-10">
            ...
            <div className="relative border-l border-[var(--accent-primary)]/65 pl-6 sm:pl-8"><p className="text-xs font-semibold uppercase tracking-[0.22em] text-[var(--accent-primary)]">{copy.ctaEyebrow}</p><h2 className="mt-4 max-w-2xl font-display text-3xl font-semibold tracking-[-0.045em] text-[var(--text-primary)] sm:text-4xl">{copy.ctaHeading}</h2><p className="mt-4 max-w-xl text-base leading-7 text-[var(--text-secondary)]">{copy.ctaDescription}</p></div>
