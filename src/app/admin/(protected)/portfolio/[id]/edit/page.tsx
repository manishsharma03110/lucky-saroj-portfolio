...
export default async function EditProjectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [tools, categories, availableProjects, relatedRows, mediaReferences] = await Promise.all([
  ...
  return (
    <div>
      ...
      <div className={styles.singleColumn}>
        <ProjectForm project={project} tools={tools} categories={categories} mediaAssetIds={mediaAssetIds} availableProjects={availableProjects} relatedProjectIds={relatedProjectIds} />
      </div>
    </div>
  );
}
