...
// The full contact page intentionally keeps the inquiry lightweight. Legacy
// project/budget/video/timeline/reference columns remain in the database so
// historic messages are preserved, but new full-page submissions do not ask
// visitors for those fields.
export const fullContactStructuralSchema = z.object({
  ...commonContactFields,
  formContext: z.literal("full"),
  phone: phoneSchema,
  projectType: z.literal(""),
  budgetRange: z.literal(""),
  videoType: z.literal(""),
  projectTimeline: z.literal(""),
  referenceUrl: z.literal(""),
});
