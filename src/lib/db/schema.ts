...
export const pageContent = pgTable("page_content", {
  ...
  check("page_content_page_key_valid", sql`${table.pageKey} IN ('about','services','experience','portfolio','contact')`),
...
export const mediaAssetReferences = pgTable("media_asset_references", {
  ...
  check("media_asset_references_slot_valid", sql`(
    ...
    OR (${table.ownerType} = 'site_settings' AND ${table.slot} IN ('hero_image','about_profile_image','logo_image','favicon','og_image'))
  )`),
