...
export type ProjectMutationInput=Omit<ParsedProjectInput,"tools"|"videoOrientation">&{videoOrientation?:ParsedProjectInput["videoOrientation"];tools:readonly string[]};
