...
The numbered migration directory now also includes RBAC/session revalidation, asset ownership, page content, activity, SEO, social metadata and video orientation migrations through 0023 (administrator last-login tracking). Consult the SQL files themselves for the complete lineage.
